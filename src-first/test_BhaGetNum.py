...
class Test_BhaGetNum:
    ...
    def test_get_num_positive_integers(self):
        result = module.get_num(5, 7)
        assert result == 12, "The function failed to correctly add two positive integers."

    def test_get_num_negative_integers(self):
        result = module.get_num(-3, -7)
        assert result == -10, "The function failed to correctly add two negative integers."

    def test_get_num_positive_and_negative_integers(self):
        result = module.get_num(5, -7)
        assert result == -2, "The function failed to correctly add a positive integer and a negative integer."

    def test_get_num_floating_point_numbers(self):
        result = module.get_num(5.5, 3.5)
        assert result == 9.0, "The function failed to correctly add two floating point numbers."
